...
public:
	...
	void computeBindWorldToJointTransformsHelper(Joint* curJoint,Matrix4f parent);


	// 2.3.2. Implement this method to compute a per-joint transform from
	// joint space to world space in the CURRENT POSE.
	void updateCurrentJointToWorldTransforms();
	void updateCurrentJointToWorldTransformsHelper(Joint* curJoint, Matrix4f& parent);
